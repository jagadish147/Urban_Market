...
class SearchProductsViewHolder(private val itemBinding: ItemSrarchProductBinding) : RecyclerView.ViewHolder(itemBinding.root) {

    fun bind(recipesItem: ProductsItem, recyclerItemListener: StoreGlobalSearchListener) {
        itemBinding.nameTxt.text = recipesItem.name

        itemBinding.root.setOnClickListener {
            recyclerItemListener.onClickProduct(recipesItem)
        }
    }
}
