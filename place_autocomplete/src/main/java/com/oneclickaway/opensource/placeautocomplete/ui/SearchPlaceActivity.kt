...
class SearchPlaceActivity : AppCompatActivity(), SearchPlaces.PlaceItemSelectedListener,
    ...
    lateinit var searchResultsRV: androidx.recyclerview.widget.RecyclerView
    ...
    lateinit var recentSearchesRV: androidx.recyclerview.widget.RecyclerView
    ...
    private fun attachLiveObservers() {
        ...
        getViewModel().getRecentSearchesData().observe(this, Observer {
            if (it != null) {
                recentSearchesRV.layoutManager =
